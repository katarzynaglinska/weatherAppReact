...
class App extends React.Component {
  ...
  changeCity = (e, cityType) =>{
    ...
    if(cityType == "firstCity"){
      ...
      this.setState({firstCityLat:cityInformations[0], firstCityLng:cityInformations[1], firstCityName: cityInformations[2]});
    }
    else{
      cityInformations = this.getCityInformations(chosenCity);
      this.setState({ secondCityLat:cityInformations[0], secondCityLng:cityInformations[1], secondCityName: cityInformations[2],});
    }
    switch (chosenCity) {
        case '0':
            ...
            <div className="container">
              <div className="row">
                <div className="col-7 col-7--no-padding">
                  <div>
                    <div className={this.state.showViewAirly ? 'manu__item manu__item--first manu__item--selected' : 'manu__item'} id="airly" onClick={(e) => this.changeMenu( e.target.id, e)}>{this.state.firstCityName}</div>
                    <div className={this.state.showViewPg ? 'manu__item manu__item--selected' : 'manu__item'} id="pg" onClick={(e) => this.changeMenu( e.target.id, e )}>{this.state.secondCityName}</div>
              ...
              <div className="row">
                <div className="col-7 col--no-padding">
                  <div className="informations informations__airly" style={{display: this.state.showViewAirly ? 'block' : 'none' }}>
                    <div class="informations__row">
                        <div class="choose-city">
                            ...
                            <div class="choose-city__select">
                                <select class="form-control" id="selectFirstCity" onChange={(e) => this.changeCity(e, "firstCity")} >
                    ...
                    <Chart url={this.state.firstCityUrl} firstCity={this.state.firstCityName} secondCity={this.state.secondCity}/>
                  </div>
                  ...
                  <div class="informations__row"> 
                    <div className="choose-city-second">
                        ...
                        <div className="choose-city__select">
                            <select className="form-control" id="selectSecondCity" onChange={(e) => this.changeCity(e, "secondCity")}>
                              <option value="0">Gdańsk</option>
                              <option value="1">Gdynia</option>
                              <option value="2">Warszawa</option>
                              <option value="3">Kraków</option>
                    ...
                    <Chart url={this.state.secondCityUrl} firstCity={this.state.firstCityName} secondCity={this.state.secondCity}/>
                  </div>
                  <div className="informations informations__comparison" style={{display: this.state.showViewComparison ? 'block' : 'none' }}>
                    <Comparison url1={this.state.firstCityUrl} url2={this.state.secondCityUrl} firstCity={this.state.firstCityName} secondCity={this.state.secondCityName}/> 
                  </div>
                </div>
                <div className="col-5 col--no-padding">
                  <div className="map">
                    <div id="mapid">
                    <Map firstCityLat={this.state.firstCityLat} firstCityLng={this.state.firstCityLng} firstCityName={this.state.firstCityName}
                         secondCityLat={this.state.secondCityLat} secondCityLng={this.state.secondCityLng} secondCityName={this.state.secondCityName}/>
                    </div>
                  </div>
                </div>
              </div>
